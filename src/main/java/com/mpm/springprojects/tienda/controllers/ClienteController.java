...
public class ClienteController {
    ...
    private List<Cliente> getClientes() {
        ...
        Clientes.add(new Cliente(1, "nombre1", "apellidos1", "corrreo1@email.com", "212121A", "123456789", "direccion1",
                true));
        Clientes.add(new Cliente(2, "nombre2", "apellidos2", "corrreo2@email.com", "313131A", "123456789", "direccion2",
                false));
